...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
  ...
  public Response setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Response setData(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer data) {
  ...
  public Response setFormat(@org.apache.thrift.annotation.Nullable String format) {
    this.format = format;
    return this;
  }
